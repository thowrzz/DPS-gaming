...
export const GAMES_LIBRARY: GameItem[] = [
  {
    id: "ea-fc-24",
    title: "FIFA / EA SPORTS FC 24",
    category: "Sports",
    players: "1 - 4 Local Co-op",
    fps: "Ultra-Smooth FPS",
    resolution: "Ultra High-Definition",
    badge: "Most Popular",
    description: "HyperMotionV technology with authentic player motion. The ultimate competitive football experience on PS5 at Korani lounge.",
    image: "/games/eafc24.png",
  },
  {
    id: "efootball-2024",
    title: "eFootball 2024 (PES)",
    category: "Sports",
    players: "1 - 4 Local Co-op",
    fps: "High Performance Mode",
    resolution: "Ultra High-Definition",
    badge: "Fan Favorite",
    description: "Tactical e-football matches with fluid ball control, realistic player mechanics, and local 2v2 tournaments.",
  ...
  },
  {
    ...
    fps: "High Performance Mode",
    resolution: "Ray Traced HD",
    badge: "Open World Classic",
    description: "Experience Los Santos enhanced for PS5 with fast loading times, haptic feedback triggers, and vibrant visual modes.",
  ...
  },
  {
    ...
    fps: "High Performance Mode",
    resolution: "Dynamic High-Definition",
    badge: "Masterpiece",
  ...
  },
  {
    ...
    fps: "High Speed Mode",
    resolution: "Ultra High-Definition",
    badge: "E-Sports Arena",
    description: "Competitive low-latency multiplayer shooting with zero input delay on flagship OLED panels.",
