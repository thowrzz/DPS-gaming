...
export const LOCAL_PAGES: Record<string, LocalPageData> = {
  attingal: {
    ...
    subheading: "Located just 5 minutes away at Korani Junction. Experience 120Hz 4K console gaming, EA FC 24 multiplayer, and luxury lounge comfort.",
    distanceInfo: "5 mins from Attingal KSRTC Bus Stand via NH66",
    metaTitle: "PS5 Gaming Lounge in Attingal | DPS Gaming Hub Korani",
    metaDescription: "Looking for the best PS5 Gaming Lounge in Attingal? DPS Gaming Hub in Korani offers 120Hz 4K gaming setups, tournaments, and luxury seating.",
    ...
    highlights: [
      ...
      "Dedicated 120Hz 4K OLED Gaming Stations",
  ...
  kazhakkoottam: {
    ...
    metaDescription: "Premier PS5 Gaming Lounge near Kazhakkoottam. 120Hz displays, DualSense Edge gear, late night sessions, and multiplayer tournaments.",
    ...
    contentStory:
      "Engineered for gamers in Kazhakkoottam who value precision, luxury, and high-performance hardware. DPS Gaming Hub offers private dual-player booths, 120Hz VRR displays, and acoustic dampening for the ultimate immersive session.",
  },
  technopark: {
    ...
    metaDescription: "Best PS5 Gaming Lounge near Technopark Kazhakkoottam. De-stress with 120Hz 4K gaming, night passes, and corporate squad tournaments.",
  ...
  trivandrum: {
    ...
    subheading: "Elevating Trivandrum's gaming ecosystem with cutting-edge 120Hz console technology, sleek dark interior design, and esports events.",
    ...
    metaDescription: "Trivandrum's premier PS5 gaming lounge. Experience 120Hz 4K displays, DualSense controllers, community tournaments, and luxury memberships.",
  ...
  kerala: {
    ...
    metaDescription: "Discover Kerala's most luxurious PS5 gaming lounge. 120Hz 4K displays, high-speed fiber internet, esports tournaments, and Apple-grade design.",
    ...
    highlights: [
      ...
      "State-of-the-art 120Hz display technology",
