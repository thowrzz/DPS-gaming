...
export const LOCAL_PAGES: Record<string, LocalPageData> = {
  attingal: {
    ...
    metaDescription: "Rent PS5 Console (₹949/day) and 43\" QLED TV with Tripod Stand (₹3000/day) in Attingal. Superfast doorstep delivery, setup, and 24/7 gaming lounge at Korani.",
    ...
    highlights: [
      ...
      "43\" QLED TV + Tripod Stand (₹3000/day) for events & parties",
    ],
    contentStory:
  ...
  varkala: {
    ...
    subheading: "Express doorstep delivery to resorts, homestays, events & homes in Varkala. PS5 rentals for ₹949/day & 43\" QLED TV with tripod stand for ₹3000/day.",
    ...
    metaDescription: "Rent PS5 (₹949/day) & 43\" QLED TV (₹3000/day) in Varkala. Express delivery to Varkala Cliff, resorts, homestays, and birthday parties with full setup.",
  ...
  venjaramoodu: {
    ...
    subheading: "Same-day doorstep rental delivery in Venjaramoodu, Pirappancode & Gokulam Medical College region. PS5 from ₹949/day and 43\" QLED TV from ₹3000/day.",
  ...
  chirayinkeezhu: {
    ...
    subheading: "Quick 8-minute delivery corridor from Korani to Chirayinkeezhu, Sharkara & Kadakkavoor. Rent PS5 for ₹949/day & QLED TV for ₹3000/day.",
  ...
  kattakada: {
    ...
    metaDescription: "Rent PS5 Console (₹949/day) & 43\" QLED TV with Stand (₹3000/day) in Kattakada. Doorstep delivery, full installation, and 24/7 technical assistance.",
    ...
    contentStory:
      "DPS Gaming Hub extends fast doorstep console and display rental delivery to Kattakada. Enjoy hassle-free delivery of PlayStation 5 consoles (₹949/day) and 43\" QLED TVs (₹3000/day) complete with heavy-duty tripod stands for any occasion.",
  },
  kazhakkoottam: {
    slug: "gaming-lounge-kazhakkoottam",
    cityName: "Kazhakkoottam",
    heroHeading: "Fast PS5 & TV Rentals near Kazhakkoottam & Technopark",
    subheading: "Express delivery across Kazhakkoottam, Kariavattom, Menamkulam & 10 mins to our Korani Lounge. PS5 from ₹949/day, TV from ₹3000/day.",
  ...
  trivandrum: {
    ...
    highlights: [
      ...
      "43\" QLED TV + Tripod Stand for ₹3000/day (Transport & Setup included)",
